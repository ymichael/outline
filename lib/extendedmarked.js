...
module.exports  =  {
    'getDoc': function(src) {
        var parser = new extendedMarked.Parser();
        return parser.parse(extendedMarked.Lexer.lex(src));
    },
    'getTableOfContents': function(src) {
        var parser = new extendedMarked.Parser();
        parser.parse(extendedMarked.Lexer.lex(src));
